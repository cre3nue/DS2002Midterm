# make date dim in newly created database from SakilaExtractTransformLoad.ipnyb:
USE sakila_etl;
...
# connection error but upped timeout times and appears to have worked upon inspection:
